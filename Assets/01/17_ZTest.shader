Shader "Custom/17_ZTest"
{
    ...
    {
        Tags { 
            "RenderType"="Transparent"  // This is just a tag for informing Rendering Pipeline of type of shader.
            "Queue"="Transparent"       // This is the render order.
        }

        Pass { // HLSL starting here

            Cull Off    // BACKFACE CULLING  // Off - Front - Back
            ZWrite Off  
            // This is the how to be drawn transparent objects and the other objects 
            ZTest GEqual    // Default Val: LEqual | GEqual - Always
            ...
            fixed4 frag (Interpolators i) : SV_Target { // SV_Target is the output! You can write multiple target. But not in case.
                ...
                float xOffset = cos(i.uv.y * TAU * 8) * 0.01;
                    ...
                    // The Time parameter supplying by unity and it has xyzw components. y is the seconds.
                
                float t = cos((i.uv.y + xOffset - _Time.y * 0.1) * TAU * 5) * 0.5 + 0.5;
                t *= 1 - i.uv.y; // This is the FadeEffect! (Bottom to Top!)

                return t * (abs(i.normal.y) < 0.999); // this calculation clearing top of cylindir.!
